...
.. ref-code-block:: cpp
	...
	public:
		...
		:target:`DecomposeDoubleQGate<doxid-class_q_panda_1_1_decompose_double_q_gate_1a31d098fa2f6cffabffd7248c9456566f>`(std::vector<std::vector<std::string>> valid_qgate_matrix);
