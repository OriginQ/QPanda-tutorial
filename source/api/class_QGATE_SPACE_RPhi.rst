.. index:: pair: class; QGATE_SPACE::RPhi
.. _doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_r_phi:
...
.. ref-code-block:: cpp
	...
	public:
		...
		:target:`RPhi<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_r_phi_1aa599ee4d868762109508e7bc1a560636>`(:ref:`QuantumGate<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_quantum_gate>`* gate_old);
	
		:target:`RPhi<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_r_phi_1aed028a2b301e040019b59ce4614e64c9>`(
			double,
			double
			);
		...
		virtual double :target:`getAlpha<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_r_phi_1a1909fdfe8511b0702bc93b143b396db7>`() const;
		virtual double :target:`getBeta<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_r_phi_1aad02531237b43b4d99c7346188d7b6e1>`() const;
		virtual double :target:`getGamma<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_r_phi_1a20d189d45c159d32942fcdabfd10cbb7>`() const;
		virtual double :target:`getDelta<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_r_phi_1ae56592dc6c5e42071f7c80c35b4a2f7a>`() const;
		double :target:`get_phi<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_r_phi_1a5f6a0e454af9ca7ddbabefc9830aab31>`() const;
		double :target:`get_theta<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_r_phi_1a885d14bb33703fc8f555494a3a3e0a6e>`() const;
	};
