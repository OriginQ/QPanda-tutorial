.. index:: pair: class; QPanda::RemapQProg
.. _doxid-class_q_panda_1_1_remap_q_prog:
...
remap a :ref:`QProg <doxid-class_q_panda_1_1_q_prog>` to new qubits
...
.. ref-code-block:: cpp
	...
	class RemapQProg: public :ref:`QPanda::TraverseByNodeIter<doxid-class_q_panda_1_1_traverse_by_node_iter>`
	{
	public:
		// methods
	
		virtual void :target:`execute<doxid-class_q_panda_1_1_remap_q_prog_1a0a3f2832f8cf107f1d29361ef1751417>`(
		...
		virtual void :target:`execute<doxid-class_q_panda_1_1_remap_q_prog_1a74f4ebbab2ccae2f760ab1295f6a5c99>`(
		...
		virtual void :target:`execute<doxid-class_q_panda_1_1_remap_q_prog_1a2cdaf55175c77ad9ab8f0daf41af7fbe>`(
		...
		virtual void :target:`execute<doxid-class_q_panda_1_1_remap_q_prog_1a728207501499e51cc5e566bd35553739>`(
		...
		virtual void :target:`execute<doxid-class_q_panda_1_1_remap_q_prog_1a3a678070bb843331e7118274043a4075>`(
		...
		:ref:`QProg<doxid-class_q_panda_1_1_q_prog>` :target:`remap<doxid-class_q_panda_1_1_remap_q_prog_1adc5807dcc75c0364d23e2ffa01d2ce98>`(
			:ref:`QProg<doxid-class_q_panda_1_1_q_prog>` src_prog,
			:ref:`QVec<doxid-class_q_panda_1_1_q_vec>` target_qv,
			std::vector<:ref:`ClassicalCondition<doxid-class_q_panda_1_1_classical_condition>`> target_cv
			);
	
		const std::map<size_t, :ref:`Qubit<doxid-class_q_panda_1_1_qubit>`*>& :target:`get_qubit_map<doxid-class_q_panda_1_1_remap_q_prog_1a8f5f8fe2e6dac7024f57eb0558749a39>`() const;
		const std::map<size_t, :ref:`ClassicalCondition<doxid-class_q_panda_1_1_classical_condition>`>& :target:`get_cbit_map<doxid-class_q_panda_1_1_remap_q_prog_1a2fadb28cfdf74f52efc06fbcdcb3359a>`() const;
	};
