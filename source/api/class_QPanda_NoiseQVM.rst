...
.. ref-code-block:: cpp
	...
	public:
		...
		void :ref:`set_noise_model<doxid-class_q_panda_1_1_noise_q_v_m_1a5cc4816d8f60ee5fb1f9b285b5b77f20>`(:ref:`NOISE_MODEL<doxid-_noise_model_8h_1a4e433c5ef943716bf3d7b430a596f8a0>` model, :ref:`GateType<doxid-_q_global_variable_8h_1a842ca6790f315b3f79faf3cda6d6789c>` type, std::vector<double> params_vec);
	};
...
.. index:: pair: function; set_noise_model
.. _doxid-class_q_panda_1_1_noise_q_v_m_1a5cc4816d8f60ee5fb1f9b285b5b77f20:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void set_noise_model(:ref:`NOISE_MODEL<doxid-_noise_model_8h_1a4e433c5ef943716bf3d7b430a596f8a0>` model, :ref:`GateType<doxid-_q_global_variable_8h_1a842ca6790f315b3f79faf3cda6d6789c>` type, std::vector<double> params_vec)

Set Noise Model.

Model type : Number of parameters DAMPING_KRAUS_OPERATOR : 1 DEPHASING_KRAUS_OPERATOR : 1 DECOHERENCE_KRAUS_OPERATOR : 3 PAULI_KRAUS_MAP : 4 or 16
...
.. list-table::
	...
	*
		...
		- params vector, the number of parameters is determined by model type
