.. index:: pair: class; QPanda::Variational::VariationalQuantumGate_H
.. _doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate___h:
...
.. ref-code-block:: cpp
	...
	class VariationalQuantumGate_H: public :ref:`QPanda::Variational::VariationalQuantumGate<doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate>`
	{
	public:
		// construction
	
		:target:`VariationalQuantumGate_H<doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate___h_1a213b34205822af9486b8b292740d9f96>`(:ref:`Qubit<doxid-class_q_panda_1_1_qubit>`* q);
	
		:target:`VariationalQuantumGate_H<doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate___h_1a8bb67fcb6f61a4f8df0a21fd8df1e6fc>`(
			:ref:`Qubit<doxid-class_q_panda_1_1_qubit>`* q,
			bool is_dagger
			);
	
		:target:`VariationalQuantumGate_H<doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate___h_1a6bf908251f8ef5169d9d6b6b9cbc0afd>`(
			:ref:`Qubit<doxid-class_q_panda_1_1_qubit>`* q,
			bool is_dagger,
			:ref:`QVec<doxid-class_q_panda_1_1_q_vec>` control_qubit
			);
	
		:target:`VariationalQuantumGate_H<doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate___h_1af3767e2f446c255e4bfa31af588d2a4f>`(const VariationalQuantumGate_H& gate);

		// methods
	
		virtual :ref:`QGate<doxid-class_q_panda_1_1_q_gate>` :ref:`feed<doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate___h_1a56df5c10f902b0848026debcd73ceebb>`();
		virtual std::shared_ptr<:ref:`VariationalQuantumGate<doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate>`> :ref:`copy<doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate___h_1a448bd0b193a7677f4c6b30462ee140b5>`();
		VariationalQuantumGate_H :target:`dagger<doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate___h_1ac3d14ff42d31cf71e86c5bbb3f352d4a>`();
		VariationalQuantumGate_H :target:`control<doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate___h_1a0af8627d2158a7409ce5de0538bd0cca>`(:ref:`QVec<doxid-class_q_panda_1_1_q_vec>` qv);
	};
...
.. _details-class_q_panda_1_1_variational_1_1_variational_quantum_gate___h:
...
.. _doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate___h_1a56df5c10f902b0848026debcd73ceebb:
...
.. _doxid-class_q_panda_1_1_variational_1_1_variational_quantum_gate___h_1a448bd0b193a7677f4c6b30462ee140b5:
