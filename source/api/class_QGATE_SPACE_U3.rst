.. index:: pair: class; QGATE_SPACE::U3
.. _doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_u3:
...
.. ref-code-block:: cpp
	...
	public:
		...
		:target:`U3<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_u3_1a1224c7f2d43a5ff969e5b97861ce9b82>`(:ref:`QuantumGate<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_quantum_gate>`* gate_old);
	
		:target:`U3<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_u3_1a85d38e1c36cbcbdf7df76ef31e8ba2c2>`(
			double,
			double,
			double
			);
		...
		virtual double :target:`getAlpha<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_u3_1a7691156006a9d1cc18be27571e4d03af>`() const;
		virtual double :target:`getBeta<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_u3_1a6ffb922fef497b3855c8e24d6f21b4d4>`() const;
		virtual double :target:`getGamma<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_u3_1abd0e44a81bb33e9efbf5635928f4ae17>`() const;
		virtual double :target:`getDelta<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_u3_1a7883d04f681ac8953b7c14d8b2b9d347>`() const;
		double :target:`get_theta<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_u3_1ab4a9b58cfa16163904792aa3317149c5>`() const;
		double :target:`get_phi<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_u3_1a7c4f73ddd2506210911519eac40746c9>`() const;
		double :target:`get_lambda<doxid-class_q_g_a_t_e___s_p_a_c_e_1_1_u3_1afb23b71a21d5518f56514ec05cf6fe44>`() const;
	};
